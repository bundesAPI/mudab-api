...
from deutschland.mudab import rest
from deutschland.mudab.configuration import Configuration
from deutschland.mudab.exceptions import ApiException, ApiTypeError, ApiValueError
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.list_mess_stationen  # this is an instance of the class Endpoint
        api_instance.list_mess_stationen()  # this invokes api_instance.list_mess_stationen.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list_mess_stationen.callable or self.callable in this class
